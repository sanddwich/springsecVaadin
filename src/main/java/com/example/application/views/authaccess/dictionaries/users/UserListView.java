...
public class UserListView extends HorizontalLayout {
    ...
    private List<AccessRole> getDetachedAccessRoles(
        ...
        accessRoleList.forEach(accessRole -> System.out.println(accessRole.getCode()));
    ...
    private void accessRolesDialogViewConfig() {
        accessRoleGrid.addClassName("p-s");
    }

    public void addAccessRoleClickHandler(ClickEvent<Button> buttonClickEvent) {
        accessRolesDialogView.accessRoleGrid.setItems(getDetachedAccessRoles(this.accessRoleService.findAll(), user.getAccessRoles()));
